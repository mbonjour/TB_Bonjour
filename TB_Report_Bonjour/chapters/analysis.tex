...
\paragraph*{Utilisation.}
Dans le cadre de ce travail je n'ai pu tester S/MIME, en effet la certification requiert un nom de domaine privé pour lequel on peut avoir des certificats. Faisant mes tests à l'aide de Gmail principalement je n'ai pu obtenir de certificats. Cependant, j'ai regardé des exemples et reçu des mails signés via S/MIME. On peut en tout cas dire que comme PGP ce n'est pas facile d'utilisation, ne serais-ce que pour obtenir un certificat.
