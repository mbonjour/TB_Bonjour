...
\begin{figure}[h!]
	...
	\centering
	\caption{Le fonctionnement d'un système de mail~\cite{mailGlobal}}
...
L'article~\cite{conf/itcs2/ErYTG12} présente une façon de faire pour chiffrer les mails à l'aide de \textit{Certificateless Cryptography}. Il va d'abord comparer 6 schémas pour choisir celui à utiliser par rapport à ses propriétés. Ensuite il va comparer les différents algorithmes au niveau du temps avec une implémentation simple en J2SE. 
