...
Dans la Table \ref{tab:recapProps}, on peut voir les différentes implémentations ainsi que les propriétés cryptographiques qu'elles atteignent. On voit surtout que Signal implémente plus d'options que les autres systèmes.
\begin{table}[]
	\centering
	\begin{tabular}{|lccc|}
		\hline
...
- Certificateless PKC~\cite{conf/asiacrypt/Al-RiyamiP03} (souvent nommé CLPKC dans la suite du cdocument).\\
