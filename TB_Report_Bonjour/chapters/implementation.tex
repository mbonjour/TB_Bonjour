...
Pour le système de clés on pourrait reprendre l'idée de~\cite{DBLP:journals/ijnsec/BalakrishnanR16} afin d'aller chercher le serveur de clés pour tel domaine.
