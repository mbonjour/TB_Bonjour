...
%TODO + d'explications sur les librairies et les choix faits (retrouver l'endoit où l'on dit que RELIC est plus efficient et est plus fait pour les POCs etc) + ref livre Alex
En lisant le livre \textit{Guide to Paring-Based Cryptography}~\cite{bookPairing}, les librairies et implémentations en Sage qui sont conseillées ainsi que des exemples de code. 
